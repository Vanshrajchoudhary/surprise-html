powershell -NoExit -command "$reasons = @(
...
'25. I that you buy me gifts (including lingerie- like wowww they look so good on you)',
'26. I love the way you taste',
'27. The way you tolerate me even when I am being annoying',
